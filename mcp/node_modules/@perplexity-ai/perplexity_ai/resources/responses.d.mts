...
export declare namespace OutputItem {
    ...
    interface SearchResultsOutputItem {
        results: Array<Shared.SearchResult>;
        type: 'search_results';
        queries?: Array<string>;
    }
    interface FetchURLResultsOutputItem {
        contents: Array<FetchURLResultsOutputItem.Content>;
        type: 'fetch_url_results';
    }
    namespace FetchURLResultsOutputItem {
        /**
...
export declare namespace ResponseStreamChunk {
    /**
    ...
    namespace ResponseCreatedEvent {
        /**
         * Non-streaming response returned when stream is false
         */
        interface Response {
    ...
    namespace ResponseInProgressEvent {
        /**
         * Non-streaming response returned when stream is false
         */
        interface Response {
    ...
    namespace ResponseCompletedEvent {
        /**
         * Non-streaming response returned when stream is false
         */
        interface Response {
     ...
     * URLs being fetched.
     */
    interface FetchURLQueriesEvent {
        /**
         * Monotonically increasing sequence number for event ordering
         */
        sequence_number: number;
     ...
     */
    interface FetchURLResultsEvent {
    ...
    namespace FetchURLResultsEvent {
        /**
         * Content fetched from a URL
         */
        interface Content {
     ...
     */
    interface ReasoningStoppedEvent {
        /**
         * Monotonically increasing sequence number for event ordering
         */
        sequence_number: number;
...
export declare namespace ResponsesCreateParams {
    interface Reasoning {
        /**
...
export interface ResponsesUsage {
    ...
    tool_calls_details?: {
        [key: string]: ResponsesUsage.ToolCallsDetails;
    };
}
